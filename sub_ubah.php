    ...
    <div class="col-sm-6">
        ...
        <form method="post">
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="kode_sub" readonly="readonly" value="<?= $row->kode_sub ?>" />
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="nama_sub" value="<?= set_value('nama_sub', $row->nama_sub) ?>" />
            </div>
            <div class="form-group">
