    ...
    <div class="row">
        <div class="col-sm-6">  
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="nama_user" value="<?=set_value($_POST['nama_user'], $row->nama_user)?>"/>
            </div>
            <div class="form-group">
                <label>Username <span class="text-danger">*</span></label>
                <input class="form-control" type="text" name="user" value="<?=set_value($_POST['user'], $row->user)?>"/>
            </div>
            <div class="form-group">
                <label>Pass <span class="text-danger">*</span></label>
                <input class="form-control" type="password" name="pass" value="<?=set_value($_POST['pass'], $row->pass)?>"/>
            </div>
            <div class="form-group">
